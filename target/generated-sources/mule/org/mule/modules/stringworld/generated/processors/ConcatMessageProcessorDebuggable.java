...
public class ConcatMessageProcessorDebuggable
    extends ConcatMessageProcessor
    implements DebugInfoProvider
{


    public ConcatMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("text1", "Text1", (java.lang.String.class), text1, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("text2", "Text2", (java.lang.String.class), text2, muleEvent));
