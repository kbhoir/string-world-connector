...
public class IndexOfMessageProcessorDebuggable
    extends IndexOfMessageProcessor
    implements DebugInfoProvider
{


    public IndexOfMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("letter", "Letter", (char.class), letter, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("text", "Text", (java.lang.String.class), text, muleEvent));
