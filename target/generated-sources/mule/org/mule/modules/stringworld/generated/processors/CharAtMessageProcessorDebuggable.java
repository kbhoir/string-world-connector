...
public class CharAtMessageProcessorDebuggable
    extends CharAtMessageProcessor
    implements DebugInfoProvider
{


    public CharAtMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("index", "Index", (int.class), index, muleEvent));
