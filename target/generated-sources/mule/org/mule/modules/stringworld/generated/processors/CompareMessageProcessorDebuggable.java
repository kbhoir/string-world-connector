...
public class CompareMessageProcessorDebuggable
    extends CompareMessageProcessor
    implements DebugInfoProvider
{


    public CompareMessageProcessorDebuggable(String operationName) {
        super(operationName);
    }
    ...
    public List<FieldDebugInfo<?>> getDebugInfo(MuleEvent muleEvent) {
        ...
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("string1", "String1", (java.lang.String.class), string1, muleEvent));
        fieldDebugInfoList.add(createDevKitFieldDebugInfo("String2", "String2", (java.lang.String.class), String2, muleEvent));
